...
Skeletor.startup = function() {
    ...
    if (Meteor.isClient) {
        ...
        Skeletor.persistentSubsManagers.settingsSubs.subscribe('findDocuments', 'Settings', {}, {}, function() {
        ...
        Tracker.autorun(function(computation) {
            if (Skeletor.Registry.configurationReady.get()) {
                let langParam = FlowRouter.getQueryParam('lang') || FlowRouter.getParam('itemLang');

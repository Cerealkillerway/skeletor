Meteor.methods({
    ...
    insertDocument: function(data, schemaName) {
        ...
        // check permissions
        if (!SkeleUtils.GlobalUtilities.checkPermissions(Skeletor.Utilities.getPermissions(collection, 'insert'))) {
    ...
    insertUser: function(data, schemaName) {
        ...
        // check permissions
        if (!SkeleUtils.GlobalUtilities.checkPermissions(Skeletor.Utilities.getPermissions('users', 'insert'))) {
            throw new Meteor.Error('unauthorized');
        }
        /*else {
            if (Meteor.isServer) {

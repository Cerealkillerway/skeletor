...
PanelRoutes.route('/sections/:itemLang', {
    subscriptions: function(params, queryParams) {
        ...
        this.register("sectionsList", subman.subscribe("findDocuments", 'Sections', {}, options));
    },
    action: function() {
...
PanelRoutes.route('/sections/:itemLang/create', {
    subscriptions: function(params, queryParams) {
        ...
        this.register("sectionNames", subman.subscribe("findDocuments", 'Sections', {}, options));
    },
    action: function() {
...
PanelRoutes.route('/sections/:itemLang/:code', {
    subscriptions: function(params, queryParams) {
        ...
        this.register("sectionData", subman.subscribe("findDocuments", 'Sections', query, {}, true));
        this.register("sectionNames", subman.subscribe("findDocuments", 'Sections', {}, options));
    },
    action: function() {
        BlazeLayout.render('panelLayout', {main: "sectionCreate"});
...
PanelRoutes.route('/pages/:itemLang', {
    subscriptions: function(params, queryParams) {
        ...
        pageOptions.fields[params.itemLang + '.title'] = 1;

        sectionOptions.fields[params.itemLang + '.name'] = 1;

        this.register("pagesList", subman.subscribe("findDocuments", 'Pages', {}, pageOptions));
        this.register('sectionCodes', subman.subscribe('findDocuments', 'Sections', {}, sectionOptions));
    },
    action: function() {
...
PanelRoutes.route('/pages/:itemLang/create', {
    subscriptions: function(params, queryParams) {
        ...
        this.register("pageCodes", subman.subscribe('findDocuments', 'Pages', {}, pageOptions));
        this.register('sectionCodes', subman.subscribe('findDocuments', 'Sections', {}, sectionOptions));
    },
    action: function() {
...
PanelRoutes.route('/pages/:itemLang/:code', {
    subscriptions: function(params, queryParams) {
        ...
        pageQuery[params.itemLang + '.code'] = params.code;
        pageOptions.fields[params.itemLang + '.code'] = 1;
        pageOptions.fields[params.itemLang + '.title'] = 1;
        ...
        this.register("pageData", subman.subscribe("findDocuments", 'Pages', pageQuery, {}, true));
        this.register("pageCodes", subman.subscribe("findDocuments", 'Pages', {}, pageOptions));
        this.register('sectionCodes', subman.subscribe('findDocuments', 'Sections', {}, sectionOptions));
    },
    action: function() {

...
Skeletor.PanelRoutes.route('/users/create', {
    subscriptions: function() {
        ...
        this.register('usernames', Skeletor.subsManagers.global.subscribe('findDocuments', 'Users', {}, userOptions));
        this.register('rolesList', Skeletor.subsManagers.global.subscribe('findDocuments', 'Roles', {}, rolesOptions));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/roles', {
    subscriptions: function() {
        ...
        this.register("rolesList", Skeletor.subsManagers.global.subscribe('findDocuments', 'Roles', {}, options));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/roles/create', {
    subscriptions: function() {
        ...
        this.register('roleNames', Skeletor.subsManagers.global.subscribe('findDocuments', 'Roles', {}, options));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/roles/:name', {
    subscriptions: function() {
        ...
        this.register('roleNames', Skeletor.subsManagers.global.subscribe('findDocuments', 'Roles', {}, options));
        this.register('role', Skeletor.subsManagers.global.subscribe('findDocuments', 'Roles', {}, {}));
    },
    action: function() {
        BlazeLayout.render('panelLayout', {main: 'roleCreate'});
    }
...
Skeletor.PanelRoutes.route('/sections/:itemLang', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('sectionsList', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', {}, sectionOptions));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/sections/:itemLang/create', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('sectionNames', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', {}, options));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/sections/:itemLang/:code', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('sectionData', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', sectionQuery, {}));
        this.register('sectionNames', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', {}, options));
    },
    action: function() {
        BlazeLayout.render('panelLayout', {main: 'sectionCreate'});
...
Skeletor.PanelRoutes.route('/pages/:itemLang', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('pagesList', Skeletor.subsManagers.global.subscribe('findDocuments', 'Pages', {}, pageOptions));
        this.register('sectionCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', {}, sectionOptions));
        this.register('menuCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Menus', {}, menuOptions));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/pages/:itemLang/create', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('pageCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Pages', {}, pageOptions));
        this.register('sectionCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', {}, sectionOptions));
        this.register('menuCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Menus', {}, menuOptions));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/pages/:itemLang/:code', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('pageData', Skeletor.subsManagers.global.subscribe('findDocuments', 'Pages', pageQuery, {}));
        this.register('pageCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Pages', {}, pageOptions));
        this.register('sectionCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Sections', {}, sectionOptions));
        this.register('menuCodes', Skeletor.subsManagers.global.subscribe('findDocuments', 'Menus', {}, menuOptions));
    },
...
Skeletor.PanelRoutes.route('/menus/:itemLang', {
    subscriptions: function(params, queryParams) {
        ...
        this.register("menusList", Skeletor.subsManagers.global.subscribe('findDocuments', 'Menus', {}, options));
    },
    action: function() {
...
Skeletor.PanelRoutes.route('/menus/:itemLang/:code', {
    subscriptions: function(params, queryParams) {
        ...
        this.register('menuData', Skeletor.subsManagers.global.subscribe('findDocuments', 'Menus', menuQuery, {}));
    },
    action: function() {
        BlazeLayout.render('panelLayout', {main: 'menuCreate'});
    }

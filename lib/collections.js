...
Skeletor.Schemas = {
    ...
    Pages_default: {
        ...
        __listView: {
            ...
            classes: 'hoverable striped',
            itemFields: ['code', 'published', 'section'],
            sourcedFields:{
                section: {
                    mapTo: ':itemLang.name',
                    collection: 'Sections'
    ...
    Menus_default: {
        __collection: "Menus",
        __paths: {
            undoPath: '/panel/menus/' + Skeletor.configuration.lang.default,
            redirectOnUpdate: ['/panel/menus/:itemLang', {itemLang: Skeletor.configuration.lang.default}],
            redirectOnCreate: ['/panel/menus/:itemLang/:code', {itemLang: Skeletor.configuration.lang.default, code: 'this'}]
        },
        __listView: {
            style: 'table',
            options: {
